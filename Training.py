...
def build_cnnmodel():
        ...
        train_dir = '..\Emotion_Stories\dataset\\train'
        val_dir = '..\Emotion_Stories\dataset\\test'
        ...
        # save model
        if os.path.exists("..\Emotion_Stories\models\cnn_model.hdf5"):
                pass

        else:
                emotion_model.save("..\Emotion_Stories\models\cnn_model.hdf5")
